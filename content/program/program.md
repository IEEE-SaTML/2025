...
##### <div class='slot-time'>08:40&ndash;09:00</div> <div class='slot-title opening'>Opening Remarks</div>
##### <div class='slot-time'>09:00&ndash;09:40</div> <div class='slot-title keynote'>Keynote: Malice, Models and Middlemen</div>
<div class="slot-block">
    Michael Veale (University College London)<br>
    <a href="/keynotes/#keynote1" class='button'><small>📃</small> Abstract</a>
</div>

##### <div class='slot-time'>09:40&ndash;10:00</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>10:00&ndash;11:00</div> <div class='slot-title session'>Session: Security of LLMs</div>
...
<li class='paper-item'>
    ...
    <span class='button' id='spot-87'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-95'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-137'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-150'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>11:00&ndash;11:20</div> <div class='slot-title coffee'>Coffee Break</div>
##### <div class='slot-time'>11:20&ndash;12:20</div> <div class='slot-title session'>Session: Adversaries and Attacks</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-72'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-127'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-176'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>12:20&ndash;13:30</div> <div class='slot-title lunch'>Lunch Break</div>
##### <div class='slot-time'>13:30&ndash;14:30</div> <div class='slot-title session'>Session: Backdoors Attacks</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-10'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-50'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-153'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-194'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>14:30&ndash;14:50</div> <div class='slot-title coffee'>Coffee Break</div>
##### <div class='slot-time'>14:50&ndash;15:20</div> <div class='slot-title competitions'>Competitions</div>
<ul class='paper-list program'>
<li class='paper-item slot-block'>
    <em class='paper-title'>🏁 Adaptive Prompt Injection: LLMail Inject</em> <br> 
    <span class='button' id='spot-AP'><small>📃</small> Abstract</span> &nbsp;
    <a class='button' href="https://microsoft.github.io/llmail-inject/"><small>🔗</small> Website</a> <br>
    <script>
        $("#spot-AP").click(function(){
            $("#abstract-AP").slideToggle("fast", "linear");
        });
    </script> 
    <blockquote class='paper-abstract' id='abstract-AP'>This competition invites participants to navigate and evade multiple prompt injection defences within an LLM-integrated email client. As an attacker, your goal is to craft emails with instructions for the LLM to execute your chosen task while avoiding detection. The competition is structured into various scenarios, each reflecting different levels of attacker knowledge and requiring successful email delivery, retrieval, and processing.
</blockquote>
</li> <li class='paper-item slot-block'>
    <em class='paper-title'>🏁 Membership Inference on Diffusion-model-based Synthetic Tabular Data</em> <br> 
    <span class='button' id='spot-MI'><small>📃</small> Abstract</span> &nbsp;
    <a class='button' href="https://vectorinstitute.github.io/MIDST"><small>🔗</small> Website</a> <br>
    <script>
        $("#spot-MI").click(function(){
            $("#abstract-MI").slideToggle("fast", "linear");
        });
    </script> 
    <blockquote class='paper-abstract' id='abstract-MI'>The MIDST challenge invites participants to assess the privacy risks of synthetic tabular data generated by diffusion models using membership inference attacks. Participants will be able to develop and apply strategies in both blackbox and whitebox settings to determine if specific data points were included in training during the synthesis of single or multi-relational tables.
</blockquote>
</li> </ul>

##### <div class='slot-time'>15:20&ndash;15:40</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>15:40&ndash;16:40</div> <div class='slot-title session'>Session: Broader Perspectives</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-58'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-96'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-141'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-178'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>16:40&ndash;17:00</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>17:00&ndash;20:00</div> <div class='slot-title posters'>Poster Session</div>
<br/><hr>

#### <div class='day-title'>Thursday, April 10, 2025</div>

##### <div class='slot-time'>09:00&ndash;09:40</div> <div class='slot-title keynote'>Keynote: The Science of Empirical Privacy Measurement: Memorization and Beyond</div>
<div class="slot-block">
...
##### <div class='slot-time'>09:40&ndash;10:00</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>10:00&ndash;11:00</div> <div class='slot-title session'>Session: Membership Inference Attacks</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-109'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-129'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-154'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-159'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>11:00&ndash;11:20</div> <div class='slot-title coffee'>Coffee Break</div>
##### <div class='slot-time'>11:20&ndash;12:20</div> <div class='slot-title session'>Session: Detection and Forensics</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-123'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-125'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-142'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>12:20&ndash;13:30</div> <div class='slot-title lunch'>Lunch Break</div>
##### <div class='slot-time'>13:30&ndash;14:30</div> <div class='slot-title session'>Session: Machine Unlearning</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-89'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-91'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-160'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-162'><small>📃</small> Abstract</span> <br>
...
<li class='paper-item slot-block'>
    ...
    <span class='button' id='spot-IA'><small>📃</small> Abstract</span> &nbsp;
    <a class='button' href="https://benchmarks.elsa-ai.eu/?ch=2&com=introduction"><small>🔗</small> Website</a> <br>
    <script>
        $("#spot-IA").click(function(){
            $("#abstract-IA").slideToggle("fast", "linear");
        });
    </script> 
    <blockquote class='paper-abstract' id='abstract-IA'>This competition invites the development of inference attacks to extract sensitive information from Document Visual Question Answering models. These models are especially vulnerable to leakage of private data, and so are especially relevant in the contexts of privacy risks and privacy-preserving ML. We provide a competition framework to encourage the implementation of practical methods that expose such privacy vulnerabilities, with the aim of better understanding real-world threat models and the robustness of differential privacy in multimodal models.
</blockquote>
</li> <li class='paper-item slot-block'>
    <em class='paper-title'>🏁 Robust Android Malware Detection Competition</em> <br> 
    <span class='button' id='spot-RA'><small>📃</small> Abstract</span> &nbsp;
    <a class='button' href="https://ramd-competition.github.io"><small>🔗</small> Website</a> <br>
    <script>
        $("#spot-RA").click(function(){
            $("#abstract-RA").slideToggle("fast", "linear");
        });
    </script> 
    <blockquote class='paper-abstract' id='abstract-RA'>The Robust Android Malware Detection Competition aims to evaluate machine learning-based detectors with respect to (i) temporal data drift due to the evolution of both malware and legitimate applications and (ii) adversarial manipulations of malware samples to evade detection. The competition consists of three separate tracks (i.e., Adversarial Robustness to Feature-space Attacks, Adversarial Robustness to Problem-space Attacks, and Temporal Robustness to Data Drift).</blockquote>
</li> </ul>

##### <div class='slot-time'>15:20&ndash;15:40</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>15:40&ndash;16:40</div> <div class='slot-title session'>Session: Private Algorithms</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-113'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-156'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-173'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-185'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>16:40&ndash;17:00</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>17:00&ndash;17:45</div> <div class='slot-title session'>Session: Vision and Perception</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-120'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-183'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>09:00&ndash;09:40</div> <div class='slot-title keynote'>Keynote: Artificial Intelligence: Should you trust it?</div>
<div class="slot-block">
...
##### <div class='slot-time'>09:40&ndash;10:00</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>10:00&ndash;11:00</div> <div class='slot-title session'>Session: Fairness and Bias</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-77'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-105'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-128'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-155'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>11:00&ndash;11:20</div> <div class='slot-title coffee'>Coffee Break</div>
##### <div class='slot-time'>11:20&ndash;12:20</div> <div class='slot-title session'>Session: Robustness and Transferability</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-7'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-57'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-86'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>12:20&ndash;13:30</div> <div class='slot-title lunch'>Lunch Break</div>
##### <div class='slot-time'>13:30&ndash;14:30</div> <div class='slot-title session'>Session: Private Learning</div>
<ul class='paper-list program'>
<li class='paper-item'>
    <em class='paper-title'>SoK: What Makes Private Learning Unfair?</em> <br> 
    Kai&nbsp;Yao, Marc&nbsp;Juarez (University&nbsp;of&nbsp;Edinburgh) <br>
    <span class='button' id='spot-9'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-116'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-122'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>14:30&ndash;14:50</div> <div class='slot-title coffee'>Coffee Break</div>
##### <div class='slot-time'>14:50&ndash;15:20</div> <div class='slot-title session'>Session: Malware and Steganography</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-104'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>15:20&ndash;15:40</div> <div class='slot-title break'>Break</div>
##### <div class='slot-time'>15:40&ndash;16:40</div> <div class='slot-title session'>Session: Differential Privacy</div>
<ul class='paper-list program'>
<li class='paper-item'>
    ...
    <span class='button' id='spot-19'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-55'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-92'><small>📃</small> Abstract</span> <br>
    ...
    <span class='button' id='spot-134'><small>📃</small> Abstract</span> <br>
...
##### <div class='slot-time'>16:40&ndash;17:00</div> <div class='slot-title closing'>Closing Remarks</div>
<br/><hr>
